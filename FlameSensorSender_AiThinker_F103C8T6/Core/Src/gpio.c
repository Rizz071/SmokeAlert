...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MOSFET_GATE_SENSOR_Pin|MOSFET_GATE_LORA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BUZZER_GPIO_Port, BUZZER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SMALL_INFO_LED_Pin INFO_LED_Pin */
  GPIO_InitStruct.Pin = SMALL_INFO_LED_Pin|INFO_LED_Pin;
