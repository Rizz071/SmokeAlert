...
static void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(RST_SIGNAL_GPIO_Port, RST_SIGNAL_Pin, GPIO_PIN_SET);
	...
	/*Configure GPIO pins : RST_SIGNAL_Pin MOSFET_GATE_Pin V_LED_Pin */
	GPIO_InitStruct.Pin = RST_SIGNAL_Pin | MOSFET_GATE_Pin | V_LED_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
